...
export const AzazelTask: Task = {
  ...
  subtasks: [
    ...
    },
    {
      ...
      available: () => Config.TaskAzazel && getProperty(AzazelQuestProperty) === "started",
    ...
    {
      name: "Get imp airs",
      available: () => Config.TaskAzazel && getProperty(AzazelQuestProperty) === "started" && itemAmount($item`imp air`) < 5,
    ...
    },
    {
      ...
      available: () => Config.TaskAzazel && getProperty(AzazelQuestProperty) === "started" && itemAmount($item`imp air`) >= 5 && itemAmount($item`bus pass`) >= 5,
      progress: () => azazelTutu(),
